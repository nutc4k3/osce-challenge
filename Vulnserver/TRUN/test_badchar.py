...
gera bytearray sem null byte:
!mona bytearray -cpb "\x00"

compara bytearray gerado com o em memoria:
!mona compare -f C:\monalogs\vulnserver\bytearray.bin -a [0022FB88](lugar que comeca os badchars no stack) 
'''
